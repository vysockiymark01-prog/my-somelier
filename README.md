...
баритоном через Web Speech API) и социальными функциями — друзья,
приглашения на вечеринки и голосование за меню напитков.

🔗 Живая версия: https://vysockiymark01-prog.github.io/my-somelier/
